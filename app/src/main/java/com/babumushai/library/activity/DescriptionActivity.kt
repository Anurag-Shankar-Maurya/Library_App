...
class DescriptionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        progressBar.visibility = View.VISIBLE     // setting visibility
        progressBarLayout = findViewById(R.id.progressBarLayout)
        progressBarLayout.visibility = View.VISIBLE   // setting visibility
                    ...
                    try {
                        ...
                        if (success) {
                            ...
                            Picasso.get().load(bookJsonObject.getString("image"))
                                .error(R.drawable.book_default_image).into(imgBookImage)
    ...
    class DBAsyncTask(val context: Context, val bookEntity: BookEntity, val mode: Int) :
        ...
        Mode 2 -> save the in DB a favourite
        Mode 3 -> remove a book from favourite
         */
        ...
        override fun doInBackground(vararg params: Void?): Boolean {
            ...
            when (mode) {
                1 -> {
                    ...
                    db.close()
                    return book !== null     // return boolean value if book is favourite
                }
